...
#
#	$Id: common.js 155 2015-10-03 06:37:34Z along $
#
#	Copyright (C) 2008-2015 PHPDisk Team. All Rights Reserved.
#
##
*/
...
function abox(url,title,width,height){
	$.jBox.open("iframe:"+url, title, width, height,{top:'5%',buttons: {}});
}
function atips(msg){
	$.jBox.tip(msg);
}
function ie_copy_text(id,msg){
	var field = getId(id);
	if (field){
		if(document.all){
