<template>
        ...
        <div id="content">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="span8">
                        <h2 style="color: brown;"> 声明</h2>
                        <art content="
  
    以下这些是 xunniun 网站服务条款,结合隐私政策和其他条款和条件使用整合的参考和可以和适用于特定的服务(“协议”)共同支配您的访问和使用 xunniun 网站内容、应用、软件産品和服务提供给您,或通过 xunniun 网站(总的来说,“服务”)。无论你有订阅,是注册用户,或者只是从一个共享的链接,下载不需要注册账户,所有这些相互作用与xunniun网站和使用任何服务是一个显式的接受这个协议意味著您已阅读,理解并同意遵守本协议的所有条款,是一个具有法律约束力的合同。
    ...
    上传服务只允许18岁以上的人使用。
    “上传服务目前只针对高级用户开放，通过网站购买的会员，目前不支持上传服务。”
